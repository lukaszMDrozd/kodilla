...
public class Forum {
    ...
    public Forum(){
        ...
        theListOfUserForum.add(new ForumUser(103, "Paul", ForumUser.UserSex.M, LocalDate.of(1977,9,17), 11));
        theListOfUserForum.add(new ForumUser(103, "Laura", ForumUser.UserSex.F, LocalDate.of(2010,8,6), 999));
        theListOfUserForum.add(new ForumUser(103, "Laura", ForumUser.UserSex.F, LocalDate.of(1956,8,6), 999));
    }
